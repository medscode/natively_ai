...
export const DEFAULT_KEYBINDS: KeybindConfig[] = [
    ...
    { id: 'chat:open-meeting-copilot', label: 'Open Meeting Copilot', accelerator: 'CommandOrControl+Shift+C', isGlobal: true, defaultAccelerator: 'CommandOrControl+Shift+C' },
